...
$templateCache.put("/application/states/user/user.html","<phi-state>\r\n\r\n    <phi-state-cover style=\"background-image: url(\'img/cover.jpg\')\" phi-color-tint=\"#01579b\">\r\n        <div>\r\n            <h1>\r\n                <span ng-bind=\"vm.person.firstName\"></span>\r\n                <span ng-bind=\"vm.person.lastName\"></span>\r\n            </h1>\r\n        </div>\r\n\r\n        <phi-state-navigation>\r\n            <phi-menu>\r\n                <phi-menu-item ui-sref=\"user.dashboard\" ui-sref-active=\"active\">Inicio</phi-menu-item>\r\n                <phi-menu-item ui-sref=\"user.profile\" ui-sref-active=\"active\">Datos personales</phi-menu-item>\r\n            </phi-menu>\r\n        </phi-state-navigation>\r\n    </phi-state-cover>\r\n\r\n    <phi-state-contents ui-view></phi-state-contents>\r\n\r\n</phi-state>");
...
$templateCache.put("/application/states/user/dashboard/dashboard.html","<div id=\"state-user-dashboard\">\r\n\r\n    <div class=\"tip\">\r\n        <h1>Bienvenido a tu cuenta</h1>\r\n        <p>Esta es tu p&aacute;gina personal.  Aqu&iacute; encontrar&aacute;s un detalle consolidado de todos los colegios que administras</p>\r\n    </div>\r\n\r\n    <section ng-if=\"state.centers.length\">\r\n\r\n        <h2>Mis centros</h2>\r\n\r\n        <ul class=\"centers\">\r\n            <li ng-repeat=\"center in state.centers\" class=\"center\" phi-texture=\"paper\" ui-sref=\"manage.home({centerId: center.id})\" phi-color-theme=\"{{center.color}}\" phi-color-border=\"500\">\r\n\r\n                <div ng-if=\"center.logo\" class=\"logo\">\r\n                    <img ng-src=\"{{center.logo}}\" alt=\"{{center.name}}\" />\r\n                </div>\r\n\r\n                <div class=\"details\">\r\n                    <h2 ng-bind=\"center.name\"></h2>\r\n                    <p class=\"category\" ng-bind=\"center.category\"></p>\r\n                </div>\r\n            </li>\r\n        </ul>\r\n\r\n    </section>\r\n\r\n\r\n    <section ng-if=\"state.claims.length\">\r\n\r\n        <h2>Solicitudes pendientes</h2>\r\n\r\n        <ul class=\"claims\">\r\n            <li ng-repeat=\"center in state.claims\" class=\"center\" phi-texture=\"paper\">\r\n\r\n                <div ng-if=\"center.logo\" class=\"logo\">\r\n                    <img ng-src=\"{{center.logo}}\" alt=\"{{center.name}}\" />\r\n                </div>\r\n\r\n                <div class=\"details\">\r\n                    <h2 class=\"phi-color-font-500\" ng-bind=\"center.name\"></h2>\r\n                    <p class=\"category\" ng-bind=\"center.category\"></p>\r\n\r\n                    <ul class=\"claims\">\r\n                        <li ng-repeat=\"claim in center.claims\">\r\n                            <p class=\"claimDate\">\r\n                                <span>solicitado</span>\r\n                                <span ng-bind=\"state.getTimestamp(claim.id) | momentCalendar\"></span>\r\n                            </p>\r\n                        </li>\r\n                    </ul>\r\n\r\n                </div>\r\n\r\n            </li>\r\n        </ul>\r\n    </section>\r\n\r\n\r\n</div>\r\n");
$templateCache.put("/application/states/user/profile/profile.html","<div id=\"state-user-profile\">\r\n\r\n    <form ng-submit=\"vm.save()\">\r\n        \r\n        <fieldset>\r\n            <legend>Datos personales</legend>\r\n\r\n            <div phi-layout=\"row\">\r\n                <phi-input label=\"Nombre\" ng-model=\"vm.parent.person.firstName\"></phi-input>\r\n                <phi-input label=\"Primer apellido\" ng-model=\"vm.parent.person.lastName\"></phi-input>\r\n                <phi-input label=\"Segundo apellido\" ng-model=\"vm.parent.person.lastName2\"></phi-input>\r\n            </div>\r\n        </fieldset>\r\n\r\n        <footer>\r\n            <button phi-button>\r\n                <span ng-show=\"!vm.status.loading && !vm.status.saved\">guardar</span>\r\n                <span ng-show=\"vm.status.loading\" phi-icon-left=\"fa-spinner\" phi-icon-animation=\"spin\">guardando</span>\r\n                <span ng-show=\"vm.status.saved\" phi-icon-left=\"fa-check\">los cambios han sido guardados</span>\r\n            </button>\r\n        </footer>\r\n\r\n    </form>\r\n\r\n</div>\r\n");
